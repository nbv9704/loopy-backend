...
(
  ...
  30,
  50,
  ARRAY['javascript', 'basics', 'types', 'chapter:1']
),
(
  'multiple_choice',
  'javascript',
  ...
  45,
  75,
  ARRAY['javascript', 'strict-mode', 'chapter:1']
),
(
  'multiple_choice',
  'javascript',
  ...
  30,
  50,
  ARRAY['javascript', 'arrays', 'chapter:1']
),
(
  'multiple_choice',
  'python',
  ...
  30,
  50,
  ARRAY['python', 'basics', 'lists', 'chapter:1']
),
(
  'multiple_choice',
  'python',
  ...
  45,
  75,
  ARRAY['python', 'control-flow', 'chapter:1']
)
...
INSERT INTO pvp_questions (
  ...
  180,
  100,
  ARRAY['javascript', 'basics', 'math', 'chapter:1']
),
(
  'code_challenge',
  'javascript',
  ...
  180,
  100,
  ARRAY['javascript', 'strings', 'chapter:1']
),
(
  'code_challenge',
  'python',
  ...
  180,
  100,
  ARRAY['python', 'lists', 'basics', 'chapter:1']
)
ON CONFLICT DO NOTHING;
