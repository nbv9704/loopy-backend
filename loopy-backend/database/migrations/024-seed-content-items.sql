-- Migration 024: Seed content items for CMS

-- Disable triggers temporarily to allow seeding without audit logs
ALTER TABLE content_items DISABLE TRIGGER content_items_audit_insert_trigger;
ALTER TABLE content_items DISABLE TRIGGER content_items_audit_update_trigger;
ALTER TABLE content_items DISABLE TRIGGER content_items_audit_delete_trigger;

-- Get category IDs and insert content
WITH categories AS (
...
-- Re-enable triggers
ALTER TABLE content_items ENABLE TRIGGER content_items_audit_insert_trigger;
ALTER TABLE content_items ENABLE TRIGGER content_items_audit_update_trigger;
ALTER TABLE content_items ENABLE TRIGGER content_items_audit_delete_trigger;
