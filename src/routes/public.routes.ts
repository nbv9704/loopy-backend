...
import { loadKeywords } from '../utils/contentModeration'
...
/**
 * GET /api/public/moderation/keywords
 * Get active banned keywords for client-side preview/warnings
 */
router.get('/moderation/keywords', async (_req, res, next) => {
  try {
