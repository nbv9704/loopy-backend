 ...
 * This migration targets tables that were DROPPED in schema-v2.sql:
 *   - exercise_submissions  (now: lesson_submissions)
 *   - test_cases            (now: lesson_test_cases)
 *   - exercises             (now: lessons)
 *
 * These schema changes are already included in:
 *   database/schema-v2.sql  — run this to reset the database.
